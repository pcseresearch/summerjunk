...
//	    step[6]=step[5]/(12*limitH);
	    ...
	    deltaH[i]=fabs(step[2]-derivative);
//	    deltaH2[i]=fabs(step[4]-derivative);
//	    deltaH3[i]=fabs(step[6]-derivative);
	    //cout<<deltaH[i]<<endl;
	    //memset(step,0,7);
	 }
...
//	p1->SetLogx(1);
//	p1->SetLogy(1);
        gr = new TGraph(numPoints,h,deltaH);
	...
	p2->SetLogx(1);
	p2->SetLogy(1);
	gr2=new TGraph(numPoints,h,deltaH2);
	...
	p3->SetLogx(1);
	p3->SetLogy(1);
	gr3=new TGraph(numPoints,h,deltaH3);
